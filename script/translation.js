const allText = {
  ...
  principeIncertitude: {
    french: `Le principe d'incertitude est l'un des principes fondamental de la physique quantique. 
        ...
        <br/> Ce principe est très important pour expliquer les mouvements des particules et pour toutes sortes de calculs nécessitant de connaitre la position ou la vitesse d'une particule.
        <br/> Sachant cela nous pouvons dire qu'on ne pourra jamais avoir de valeurs précise des deux valeurs ce qui importe une incertitude toujours présente.
        <br/> Pour mieux comprendre ce principe, l'animation ci-contre est plus parlante. Quand une des deux variables est sur 0 cela signifie que nous connaissons la valeur très précisément. 
        <br/> Dans le cas contraire, quand la valeur est sur 100, la valeur est inconnue est de ce fait égale à l'infini.
        <br/> Par exemple plus la particule semble petite mieux nous connaissons sa position, et plus elle devient rapide moins nous connaissons sa vitesse.`,
    english: `The uncertainty principle is one of the fundamental principles of quantum physics.
    ...
    spanish: `El principio de incertidumbre es uno de los principios fundamentales de la física cuántica.
        <br/> Este principio dice que cuanto más conocemos la posición de una partícula, menos podemos conocer su cantidad de movimiento (o velocidad).
        <br/> Por ejemplo, la pequeña animación contigua representa la precisión de la cantidad de movimiento en relación con la posición de la partícula.
        <br/> Este principio es muy importante para explicar los movimientos de las partículas y para todo tipo de cálculos que requieran conocer la posición o la velocidad de una partícula.
        <br/> Sabiendo esto podemos decir que nunca podremos tener valores precisos de los dos valores lo que importa una incertidumbre siempre presente.
        <br/> Para entender mejor este principio, la animación opuesta es más reveladora. Cuando una de las dos variables está en 0 significa que conocemos el valor con mucha precisión.
        <br/> De lo contrario, cuando el valor está en 100, el valor es desconocido y, por lo tanto, es igual a infinito.
        <br/> Por ejemplo, cuanto más pequeña parece la partícula, mejor conocemos su posición, y cuanto más rápida se vuelve, menos conocemos su velocidad.`,
    german: `Die Unschärferelation ist eines der Grundprinzipien der Quantenphysik.
        <br/> Dieses Prinzip besagt, je mehr wir die Position eines Teilchens kennen, desto weniger können wir seinen Impuls (oder seine Geschwindigkeit) kennen.
        <br/> Die nebenstehende kleine Animation stellt beispielsweise die Genauigkeit der Bewegungsgröße in Bezug auf die Position des Partikels dar.
        <br/> Dieses Prinzip ist sehr wichtig, um die Bewegungen von Teilchen zu erklären und für alle Arten von Berechnungen, die die Kenntnis der Position oder der Geschwindigkeit eines Teilchens erfordern.
        <br/> Wenn wir dies wissen, können wir sagen, dass wir niemals genaue Werte der beiden Werte haben können, was eine immer vorhandene Unsicherheit ausmacht.
        <br/> Um dieses Prinzip besser zu verstehen, ist die nebenstehende Animation aussagekräftiger. Wenn eine der beiden Variablen auf 0 steht, bedeutet dies, dass wir den Wert sehr genau kennen.
        <br/> Andernfalls, wenn der Wert auf 100 steht, ist der Wert unbekannt und daher gleich unendlich.
        <br/> Je kleiner beispielsweise ein Partikel erscheint, desto besser kennen wir seine Position, und je schneller es wird, desto weniger kennen wir seine Geschwindigkeit.`,
  },
};
  ...
  switch (window.location.pathname) {
    ...
    case "/quantumPhysics/fentesYoung.html":
      ...
      if (localStorage.getItem("language") === "french") {
        ...
        $("#warning p").html(
          "This animation is not representative of the reality."
        );
        ...
        $("#warning p").html(
          "Esta animación no es representativa de la realidad."
        );
        ...
        $("#warning p").html(
          "Diese Animation ist nicht repräsentativ für die Realität"
        );
    ...
    case "/quantumPhysics/famousFormula.html":
      ...
      if (localStorage.getItem("language") === "french") {
        ...
        $(".descriptions")
          .eq(3)
          .html(allText.famousFormula.french.superposition);
        ...
        $(".descriptions")
          .eq(1)
          .html(allText.famousFormula.english.schrodinger);
        $(".descriptions").eq(2).html(allText.famousFormula.english.heisenberg);
        $(".descriptions")
          .eq(3)
          .html(allText.famousFormula.english.superposition);
        ...
        $(".descriptions")
          .eq(1)
          .html(allText.famousFormula.spanish.schrodinger);
        $(".descriptions").eq(2).html(allText.famousFormula.spanish.heisenberg);
        $(".descriptions")
          .eq(3)
          .html(allText.famousFormula.spanish.superposition);
        ...
        $(".descriptions")
          .eq(3)
          .html(allText.famousFormula.german.superposition);
    ...
    case "/quantumPhysics/ondeCorpuscule.html":
      ...
      if (localStorage.getItem("language") === "french") {
        ...
        $("#title").html("Welle-Teilchen-Dualität");
    ...
    case "/quantumPhysics/principeIncertitude.html":
      ...
      if (localStorage.getItem("language") === "french") {
        $("#title").html("Principe d'incertitude");

        $("#mainContent").html(allText.principeIncertitude.french);

        $("#frenchFlag").trigger("click");
      } else if (localStorage.getItem("language") === "english") {
        $("#title").html("Uncertainty principle");

        $("#mainContent").html(allText.principeIncertitude.english);

        $("#englishFlag").trigger("click");
      } else if (localStorage.getItem("language") === "spanish") {
        $("#title").html("Principio de incertidumbre");

        $("#mainContent").html(allText.principeIncertitude.spanish);

        $("#spanishFlag").trigger("click");
      } else if (localStorage.getItem("language") === "german") {
        $("#title").html("Unschärferelation");

        $("#mainContent").html(allText.principeIncertitude.german);
